...
|------|----------|---------------|
| SAST | Static Application Security Testing | Static analysis tools |
| DAST | Dynamic Application Security Testing | Dynamic testing tools |
| IAST | Interactive Application Security Testing | Interactive testing tools |
| SCA | Software Composition Analysis | Composition analysis tools |
| SBOM | Software Bill of Materials | SBOM formats |
| DevSecOps | CI/CD Security Integration | GitLab Security, GitHub Advanced Security |
| SLSA | Supply-chain Levels for Software Artifacts | Supply chain integrity tools |
| Container | Container Image Security | Container scanning tools |
| API | API Security Testing | API security testing tools |
| Secret | Secret Detection | Secret scanning tools |
| IaC | Infrastructure-as-Code Security | IaC scanning tools |
| Mobile | Mobile App Security Testing | Mobile security testing tools |
| Shielding | Mobile App Shielding | App shielding tools |
| Pentest | Application Penetration Testing | Penetration testing |
| Threat | Threat Modeling | STRIDE, PASTA |
| Training | Secure Coding Training | Security training platforms |

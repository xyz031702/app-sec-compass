...
| Mobile SAST | Static analysis tools Mobile | Continuous code analysis |
| Mobile DAST | Mobile security testing tools | Runtime vulnerability testing |
...
| Category | Tool/Practice | How It Addresses the Control |
|----------|--------------|------------------------------|
| Mobile App Shielding | App shielding tools DexGuard | Runtime protection |

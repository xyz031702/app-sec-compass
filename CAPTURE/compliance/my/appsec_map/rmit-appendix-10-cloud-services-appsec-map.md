...
|----------|--------------|------------------------------|
| Container Security | Trivy, Grype | Scan YOUR container images |
...
| IaC Security | Checkov, tfsec | Scan YOUR Terraform/CloudFormation |
| Secret Detection | GitLeaks, TruffleHog | Detect secrets in YOUR code |

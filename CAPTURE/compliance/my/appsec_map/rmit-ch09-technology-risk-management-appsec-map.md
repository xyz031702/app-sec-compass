...
| SCA | Snyk, Black Duck | (c)(f) Identify third-party component risks |
| SAST | SonarQube, Checkmarx | (e)(f) Risk measurement via severity scoring |
| DAST | OWASP ZAP, Burp Suite | (f)(g) Risk controls validation, continuous testing |
...
| Container Security | Trivy, Grype | (d) Container/image classification |

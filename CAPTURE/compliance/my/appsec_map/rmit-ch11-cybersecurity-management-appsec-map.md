...
| SAST | SonarQube, Checkmarx | **Protect** - secure code |
| SCA | Snyk, Black Duck | **Protect** - secure dependencies |
| DAST | OWASP ZAP, Burp Suite | **Detect** - find runtime vulnerabilities |
...
| SAST | SonarQube, Checkmarx | (c) Code vulnerability identification |
| DAST | OWASP ZAP, Burp Suite | (c) Runtime vulnerability detection |
| SCA | Snyk, Black Duck | (c) Third-party vulnerabilities |
...
| Secret Detection | GitLeaks, TruffleHog | **Exfiltration** - prevent credential exposure |
